...
% layer_sensitive.m
%
% Model exported on Aug 1 2026, 05:02 by COMSOL 6.2.0.290.
...
model.modelPath('D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3');
...
model.label('2layer.mph');
model.label('2layer.mph');

model.component('comp1').coordSystem.remove('pml1');

model.component('comp1').physics('emw').create('sctr1', 'Scattering', 2);
model.component('comp1').physics('emw').feature('sctr1').selection.set([5 6 7 8 32 33 48 65]);

model.label('2layer.mph');

model.component('comp1').cpl.create('intop1', 'Integration');
model.component('comp1').cpl('intop1').set('axisym', true);
model.component('comp1').cpl('intop1').selection.set([]);
...
model.component('comp1').cpl('intop1').selection.set([9 10 18 19]);
...
model.component('comp1').func('int3').set('funcname', 'int_Et_x_re');
...
model.study('std1').feature('sens').setIndex('optobj', 'intop1((emw.Ex-(int_Et_x_re(x,y,z)+i*int_Et_x_im(x,y,z)))^2 + (emw.Ey-(int_Et_y_re(x,y,z)+i*int_Et_y_im(x,y,z)))^2 + (emw.Ez-(int_Et_z_re(x,y,z)+i*int_Et_z_im(x,y,z)))^2)', 0);

model.component('comp1').func('int3').importData;
model.component('comp1').func('int3').importData;
model.component('comp1').func('int3').set('filename', 'D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3\Et_x_im.csv');
model.component('comp1').func('int3').setIndex('funcs', 'int_Et_x_re', 0, 0);
model.component('comp1').func.create('int4', 'Interpolation');
model.component('comp1').func('int4').set('source', 'file');
model.component('comp1').func('int4').set('filename', 'D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3\Et_x_re.csv');
model.component('comp1').func('int4').setIndex('funcs', 'int_Et_x_im', 0, 0);
...
model.component('comp1').func('int5').set('filename', 'D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3\Et_y_re.csv');
model.component('comp1').func('int5').setIndex('funcs', 'int_Et_y_re', 0, 0);
model.component('comp1').func('int3').setIndex('funcs', 'int_Et_x_im', 0, 0);
model.component('comp1').func('int4').setIndex('funcs', 'int_Et_x_re', 0, 0);
model.component('comp1').func('int6').set('source', 'file');
model.component('comp1').func('int6').set('filename', 'D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3\Et_y_im.csv');
model.component('comp1').func('int6').setIndex('funcs', 'int_Et_y_im', 0, 0);
model.component('comp1').func('int7').set('source', 'file');
model.component('comp1').func('int7').set('filename', 'D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3\Et_z_re.csv');
model.component('comp1').func('int7').setIndex('funcs', 'int_Et_z_re', 0, 0);
model.component('comp1').func('int8').set('source', 'file');
model.component('comp1').func('int8').set('filename', 'D:\ZJU\PROJECT\2026-07-02-qoder-engine\COMSOL\pipline3\Et_z_im.csv');
model.component('comp1').func('int8').setIndex('funcs', 'int_Et_z_im', 0, 0);

model.study('std1').feature('sens').setIndex('optobj', 'int_Et_x_re(x,y,z)', 1);
model.study('std1').feature('sens').setIndex('optobj', 'int_Et_x_re', 1);
model.study('std1').feature('sens').setIndex('optobj', 'int1', 1);
model.study('std1').feature('sens').setIndex('optobj', 'int1(x,y,z)', 1);
model.study('std1').feature('sens').setIndex('optobj', '', 1);
...
model.study('std1').feature('sens').setIndex('optobj', 'x', 1);
model.study('std1').feature('sens').setIndex('optobj', 'int1(x,y,z) + i*int2(x,y,z)', 1);
model.study('std1').feature('sens').setIndex('optobj', '', 1);
...
model.component('comp1').func('int8').importData;
model.component('comp1').func('int7').importData;
model.component('comp1').func('int6').importData;
model.component('comp1').func('int5').importData;
model.component('comp1').func('int4').importData;
model.component('comp1').func('int3').importData;
...
model.study('std1').feature('sens').setIndex('pname', 'eps_re_ctrl', 2);
model.study('std1').feature('sens').setIndex('initval', 3, 2);
model.study('std1').feature('sens').setIndex('scale', 1, 2);
model.study('std1').feature('sens').setIndex('valuetype', 'real', 2);
model.study('std1').feature('sens').setIndex('pname', '', 2);
model.study('std1').feature('sens').setIndex('initval', 3, 2);
model.study('std1').feature('sens').setIndex('scale', 1, 2);
model.study('std1').feature('sens').setIndex('valuetype', 'real', 2);
model.study('std1').feature('sens').setIndex('pname', '', 2);
model.study('std1').feature('sens').remove('initval', 2);
model.study('std1').feature('sens').remove('scale', 2);
model.study('std1').feature('sens').remove('valuetype', 2);
model.study('std1').feature('sens').remove('pname', [2]);

model.component('comp1').common.create('cvf1', 'ControlVariableField');
model.component('comp1').common('cvf1').set('name', 'epsi_re');
...
model.component('comp1').common('cvf1').selection.set([9 10 11 12 18 19 22 23]);

model.component('comp1').view('view1').hideEntities('hide1').add([18]);

model.component('comp1').common('cvf1').selection.set([9 10 11 12 13 18 19 22 23]);
model.component('comp1').common.create('cvf2', 'ControlVariableField');
model.component('comp1').common('cvf2').set('name', 'epsi_im');
model.component('comp1').common('cvf2').selection.set([9 10 11 12 13 19 22 23]);
...
model.component('comp1').common('cvf2').selection.set([9 10 11 12 13 18 19 22 23]);
