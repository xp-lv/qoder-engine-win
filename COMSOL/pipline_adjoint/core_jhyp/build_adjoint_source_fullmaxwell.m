...
% coeff_base: 数学推导修正
%   dF/dε = -2ω²ε₀·dV·Re[λ_true · E]  （bilinear，无共轭）
%   λ_true = K⁻¹ · conj(f_adj^raw)
%   其中 f_adj^raw = w(s)·(Js_raw + Ms_raw)（不含全局系数）
%   coeff_base 不再含 0.5i·ω·ε₀（数学错误）
coeff_base = 0.5i * omega * eps0;  % 原始 sign 正确版本
